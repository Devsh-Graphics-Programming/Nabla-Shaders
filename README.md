# PROJECT IS SUSPENDED - Trying to use HLSL202x
...
This project was to be developed for use by the [Nabla](https://github.com/Devsh-Graphics-Programming/Nabla) Rendering Framework, however after realizing its potential we decided to make develop it in a standalone repository.
